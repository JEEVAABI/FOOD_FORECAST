...
model_structure = [
    ...
    # Add more edges as needed for other food items
]
...
input_day = input('Enter the day (e.g., MONDAY): ')  # Replace this with the actual day you want to input
...
#selected_columns = predicted_data.columns[predicted_data.iloc[0] == 1]
selected_columns = predicted_data.columns[predicted_data.iloc[0] == 1].tolist()

print(selected_columns)

"""**MULTI LAYER PERCEPTRON MODEL TO PREDICT FOOD COUNT**"""
